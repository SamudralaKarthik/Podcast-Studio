...
$check = "select * from follow where user_id = '$user_id' and follower_id = '$followerid'";


$a = pg_query($dbconn,$check);
if(isset($_POST['follow'])){
    $userid = $_SESSION['id'];
    $followerid = $_SESSION['user_id'];
    $sql1 = "insert into follow(user_id,follower_id) values('$userid','$followerid')";
    $run = pg_query($dbconn,$sql1);
    $sql1 = "update user_details SET following = following + 1 where user_id = '$followerid'";
    $run = pg_query($dbconn,$sql1);
    $sql1 = "update user_details SET followers = followers + 1 where user_id = '$userid'";
    $run = pg_query($dbconn,$sql1);
    header('Location:Prajwal.php');
}
if(isset($_POST['following'])){
    $userid = $_SESSION['id'];
    $followerid = $_SESSION['user_id'];
    $sql1 = "delete from follow where user_id = '$userid' and follower_id = '$followerid'";
    $run = pg_query($dbconn,$sql1);
    $sql1 = "update user_details SET following = following - 1 where user_id = '$followerid'";
    $run = pg_query($dbconn,$sql1);
    $sql1 = "update user_details SET followers = followers - 1 where user_id = '$userid'";
    ...
    <div class="col-md-10 mx-auto">
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    ...
                    <div class="media-body mb-5 text-white">
                        <h4 class="mt-0 mb-0"><?php echo $arr['username'] ?></h4>
                        <p></p>
                    </div>
                </div>
            </div>
            <div class="bg-light p-4 d-flex justify-content-end text-center">
                ...
                <form action="Prajwal.php" method="POST">
                    
                        <?php
                        if(pg_num_rows($a)!=1){
                        ?>
                            <button id="custom-btn" type="submit" name = 'follow'>Follow</button>
                        <?php } 
                        else{
                        ?>
                            <button id="custom-btn" type="submit" name = 'following'>Following</button>
                        <?php }?>
                    ...
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block" style="padding-left: 5px;"><?php echo $arr['post']; ?></h5><small class="text-muted"> <i class="fas fa-image mr-1"></i>Posts</small>
                    </li>
                    <!-- <li class="list-inline-item">
                    ...
                    <li class="nav-item dropdown list-inline-item">
                        <a class="nav-link dropdown-toggle" style="color: black;" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <h5 class="font-weight-bold mb-0 d-block" style="padding-left: 5px;"><?php echo $arr['followers']; ?></h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Followers</small>
                        </a>
                    ...
                    <li class="nav-item dropdown list-inline-item">
                        <a class="nav-link dropdown-toggle" style="color: black;" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <h5 class="font-weight-bold mb-0 d-block" style="padding-left: 5px;"><?php echo $arr['following']; ?></h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Following</small>
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <?php
